var main = function(){
	...
	$.getJSON(url, function (Issues){
		Issues.forEach(function(issue){
			...
			$issueRows +="<tr><td>" + issue.ID 
			+ "</td><td>" + issue.Title
			+ "</td><td>" + issue.AssignedTo
			+ "</td><td>" + issue.OpenedBy
			+ "</td><td>" + issue.OpenedDate
			+ "</td><td>" + issue.DueDate
			+ "</td><td>" + issue.Status
			+ "</td><td>" + issue.Category
			+ "</td><td>" + issue.Priority
			+ "</td><td>" + issue.Description
			+ "</td><td>" + issue.RelatedIssue
			+"</td><td>&nbsp;</td></tr>";
